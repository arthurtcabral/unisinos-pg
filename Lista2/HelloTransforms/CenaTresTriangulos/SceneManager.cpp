...
void SceneManager::initializeGraphics()
{
	...
	addShader("../shadersCenaTresTriangulos/transformations.vs", "../shadersCenaTresTriangulos/transformations.frag");
...
void SceneManager::render()
{
	...
	model = glm::mat4();
	model = glm::rotate(model, (GLfloat)glfwGetTime(), glm::vec3(0.0f, 0.0f, -0.2f));
